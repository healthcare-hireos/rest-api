...
export class update1618744235049 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "offer" DROP COLUMN "agreement_type_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" DROP CONSTRAINT "FK_8acdf035a05826e5b4491cc08d7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "salary_from" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "salary_to" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "paid_till" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "paid_till" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "salary_to" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "salary_from" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ADD CONSTRAINT "FK_8acdf035a05826e5b4491cc08d7" FOREIGN KEY ("specialization_id") REFERENCES "specialization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ADD "agreement_type_id" integer NOT NULL`,
    );
